            ...
            if ('persona_id' in botItemData && botItemData.persona_id) {
                try {
                    ...
                    const fetchedPersona = await personasService.getPersona(
                        botItemData.persona_id
                    );
                    if (fetchedPersona && fetchedPersona.face_id) {
                        const imageUrl =
                            personaImages[fetchedPersona.face_id] || botIcon;
            ...
            <div className="bot-card-body">
                <div className="bot-card-header-with-button">
                    ...
                    {agentViewType === AgentViewType.MyAgents &&
                        'status' in botItemData &&
                        botItemData.status === 'public' && (
                            <button
                ...
                <p className="bot-card-description">
                    {botItemData.description}
                </p>
            </div>
            <div className="bot-buttons-area">
                {agentViewType === AgentViewType.MyAgents ||
                agentViewType === AgentViewType.Personas ? (
                    <>
                        <SecondaryButton
                            text="Delete"
                    ...
                    <PrimaryButton
                        text="Go to Course"
                        onClick={() => onBotSelect(botItemData)}
                        enabled={true}
                    />
                )}
            </div>
