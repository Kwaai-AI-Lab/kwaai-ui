    ...
    return (
        <div className="status-container">
            <span className="status-title">
                Are you ready to share {bot.name} assistant?
            </span>
            <div className="status-radio-buttons">
                <div
                    className={`status-radio-wrapper ${bot.status === 'private' ? 'active' : ''}`}
                >
                    <label>
                        <input
                            type="radio"
                ...
                <div
                    className={`status-radio-wrapper ${bot.status === 'public' ? 'active' : ''}`}
                >
                    <label>
                        <input
                            type="radio"
                ...
                <div
                    className={`status-radio-wrapper ${bot.status === 'draft' ? 'active' : ''}`}
                >
                    <label>
                        <input
                            type="radio"
            ...
            <div className="status-checkbox-wrapper">
                ...
                <p className="caption">
                    * If you allow editing, others can make changes to this
                    assistant. *
                </p>
            </div>
        </div>
